...
void Patterns::simplePattern(Adafruit_NeoPixel strip, uint32_t colors[], int num_colors) {
...
void Patterns::WithSpacing(Adafruit_NeoPixel strip, uint32_t colors[], int num_colors, int spacing) {
  int string_length = strip.numPixels();
